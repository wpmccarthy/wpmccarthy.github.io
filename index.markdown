...
<p>I’m a Senior AI Research Scientist at Autodesk, specializing in large-scale dataset creation for models that generate and edit 3D CAD. </p>
</div>
</div>

<p>My work bridges machine learning, cognitive science, and HCI, with the goal of developing AI systems that enhance, rather than replace, human creativity. I earned my PhD in Cognitive Science in the [Cognitive Tools Lab](https://cogtoolslab.github.io) (UC San Diego), where I investigated how creative behaviors impact downstream cognition. I’ve published research papers in leading AI venues, such as NeurIPS, ICLR, EMNLP, and Cognitive Science.</p>
<!-- 
